...
@section('titre')
    ...
    <h1>Auteur : {{$project->user->name}}</h1>
    ...
    <table class="table table-hover table-bordered .table-responsive">
        ...
        <form class="" action="{{route('modifProjet', [$project->id])}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$project->nom}}" name="newprojecttitle" placeholder="entrer le nouveau titre du projet">
            </div>
            <div class="form-group">
                <label for="projectdescriptive" name="projectdescriptive">Descriptif du Projet </label>
                <input type="text" class="form-control" value="{{$project->prix}}" name="newprojectdescriptive" placeholder="entrer le nouveau descriptif du projet">
            </div>
